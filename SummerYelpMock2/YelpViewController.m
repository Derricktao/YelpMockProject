...
{
    DetailYelpViewController *detailYelpVC = [[DetailYelpViewController alloc] initWithDataModel:self.dataModels[indexPath.row]];
    [self.navigationController pushViewController:detailYelpVC animated:YES];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == [self.dataModels count] - 4) {
        ...
        [[YelpNetworking sharedInstance] fetchRestaurantsBasedOnLocation:loc term:@"restaurant" parameters:parameter
            completionBlock:^(NSArray<YelpDataModel *> *dataModelArray)
  {
...
- (void)searchBarCancelButtonClicked:(UISearchBar *)searchBar {
    ...
    if (!loc) {
        //mock loc
        CLLocation *loc = [[CLLocation alloc] initWithLatitude:38.544907 longitude:-121.740517];
    }
