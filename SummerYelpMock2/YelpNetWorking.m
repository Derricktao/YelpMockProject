...
static NSString const * kClient_id = @"zoY8tlqhMj3K_LwfH8D-_g";
static NSString const * kClient_secret = @"b2PPJFCpAljO2Is2MAEgHmF87EmZhXlSnOxdC5XMCKdBXuaPdSgKZPGs8lYrwI64";
static NSString const * kTokenEndPoint = @"https://api.yelp.com/oauth2/token";
@interface YelpNetworking ()
@property (copy) NSString *token;
@end

@implementation YelpNetworking:NSObject
